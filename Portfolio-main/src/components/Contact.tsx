    ...
    <section className="relative z-20 bg-[#0a0a0a] py-32 px-4 md:px-12 overflow-hidden" id="contact">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-bold mb-6 text-white tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-500">
                together.
                <span className="inline-block ml-3 align-middle group-hover:rotate-12 transition-transform duration-500">
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-[0_0_10px_rgba(168,85,247,0.5)]">
                    <path d="M23 19C23 20.1046 22.1046 21 21 21H3C1.89543 21 1 20.1046 1 19V8C1 6.89543 1.89543 6 3 6H7L9 3H15L17 6H21C22.1046 6 23 6.89543 23 8V19Z" stroke="url(#camera-grad)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    <circle cx="12" cy="13" r="4" stroke="url(#camera-grad)" strokeWidth="1.5" />
                    <circle cx="18" cy="9" r="0.5" fill="#A855F7" />
                    <defs>
                      <linearGradient id="camera-grad" x1="1" y1="3" x2="23" y2="21" gradientUnits="userSpaceOnUse">
            ...
            <p className="text-gray-400 text-lg mb-10 max-w-md leading-relaxed">
              I'm currently available for freelance creative work and open to full-time opportunities.
              If you have a project or poster design that needs some creative touch, I'd love to hear about it.
            </p>
            ...
            <div className="flex flex-col gap-6 mb-12">
              <a href="mailto:[EMAIL_ADDRESS]" className="flex items-center gap-4 text-gray-300 hover:text-white transition-colors group">
                ...
                <span className="text-lg">meetedits9@gmail.com</span>
              </a>
              ...
              <div className="flex items-center gap-4">
                ...
                <SocialLink href="https://wa.me/919867976939" icon={<WhatsappIcon />} label="WhatsApp" />
              </div>
            </div>

            <a
              href="/MeetGohilResume.pdf"
              download
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell me about your creative needs..."
                  required
                />
              </div>
        ...
        <footer className="mt-24 pt-8 border-t border-white/5 text-center text-gray-500 font-mono text-sm">
          <p>&copy; {new Date().getFullYear()} Meet Gohil. All rights reserved.</p>
        </footer>
      </div>
    </section>
  );
...
const WhatsappIcon = () => (
  <svg viewBox="0 0 24 24" width="20" height="20" stroke="none" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.345-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.445 0 .081 5.363.079 11.971c0 2.112.553 4.177 1.603 6.002L0 24l6.163-1.617a11.83 11.83 0 005.883 1.564h.005c6.604 0 11.967-5.367 11.97-11.97.001-3.202-1.242-6.212-3.504-8.475" /></svg>
);
