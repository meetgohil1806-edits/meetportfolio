...
const Shuffle = ({
        ...
        () => {
            ...
            const removeHover = () => {
                if (hoverHandlerRef.current && ref.current) {
                    (ref.current as any).removeEventListener('mouseenter', hoverHandlerRef.current);
            ...
            const build = () => {
                ...
                chars.forEach((ch: any) => {
                    ...
                    if (colorFrom) (inner as any).style.color = colorFrom;
            ...
            const randomizeScrambles = () => {
                ...
                wrappersRef.current.forEach(w => {
                    ...
                    for (let i = 1; i < kids.length - 1; i++) {
                        (kids[i] as any).textContent = scrambleCharset.charAt(Math.floor(Math.random() * scrambleCharset.length));
                    }
                });
            };
            ...
            const armHover = () => {
                ...
                (ref.current as any).addEventListener('mouseenter', handler);
            };
    ...
    const Tag = tag || 'p';
    return React.createElement(Tag as any, { ref, className: classes, style: commonStyle }, text);
};
